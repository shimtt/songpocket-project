      ...
      <div className="App">
        <div className="latte-section">
          <div className="latte-title">
            ...
            <Routes>
              {/* 기본 경로 RealtimeRanking + CategoryList*/}
              <Route path="/" element={<RealtimeRanking playlist={playlist} setPlaylist={setPlaylist} />} />

              {/* latte 경로는 LatteSongList로 이동, 자식 컴포넌트에 props 전달 */}
              <Route path="/realtime" element={<RealtimeRanking playlist={playlist} setPlaylist={setPlaylist} />} />
